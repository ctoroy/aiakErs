(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("sta03","20","60",null,"90","20",null,null,null,null,null,this);
            obj.set_taborder("15");
            ...
            obj.set_text("nexacroN 파일 up/down Transfer 컴포넌트 Sample.");
            this.addChild(obj.name, obj);

            obj = new Button("btnDel",null,"171","69","30","93",null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("삭제");
            ...
            obj = new Grid("grdFileUpload","20","207",null,"143","20",null,null,null,null,null,this);
            obj.set_taborder("1");
            ...
            obj = new Button("btnSave",null,"171","69","30","20",null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("전송");
            obj.set_positionstep("0");
            obj.set_cssclass("btn_WF_basic01");
            ...
            obj = new Grid("grdFileDownload","20","390",null,null,"20","30",null,null,null,null,this);
            obj.set_taborder("3");
            ...
            obj = new Button("btnDonwload",null,"354","106","30","20",null,null,null,null,null,this);
            obj.set_taborder("4");
            ...
            obj = new Button("btnSearch",null,"354","106","30","132",null,null,null,null,null,this);
            obj.set_taborder("5");
            ...
            obj = new Button("btnAdd",null,"171","69","30","167",null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("추가");
            obj.set_cssclass("btn_WF_basic01");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staSupportDnd","35","87","233","23",null,null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_text("▶ drag and drop <fc v=\'red\'>지원</fc>");
            obj.set_font("bold 12px/normal \"Gulim\",\"Arial\"");
            obj.set_usedecorate("true");
            this.addChild(obj.name, obj);

            obj = new Static("staSupportPgb","35","105","233","23",null,null,null,null,null,null,this);
            obj.set_taborder("9");
            ...
            obj = new Static("staSupportMulti","35","125","233","23",null,null,null,null,null,null,this);
            obj.set_taborder("10");
            ...
            obj = new Static("sta04","20","146","464","30",null,null,null,null,null,null,this);
            obj.set_taborder("11");
            obj.set_text("H30");
            ...
            obj = new Static("Static00","20","179","178","28",null,null,null,null,null,null,this);
            obj.set_taborder("12");
            obj.set_text("1) file upload");
            obj.set_font("bold 10pt \"맑은 고딕\"");
            this.addChild(obj.name, obj);

            obj = new Static("sta05","25","199","424","10",null,null,null,null,null,null,this);
            obj.set_taborder("13");
            obj.set_text("H10");
            ...
            obj = new Static("Static01","21","360","138","28",null,null,null,null,null,null,this);
            obj.set_taborder("14");
            obj.set_text("2) file download");
            obj.set_font("bold 10pt \"맑은 고딕\"");
            this.addChild(obj.name, obj);

            obj = new Static("sta05_00","26","380","424","10",null,null,null,null,null,null,this);
            obj.set_taborder("16");
            obj.set_text("H10");
            obj.set_background("RGBA(23,211,35,0.30)");
            obj.set_visible("false");
            ...
            obj = new Static("staSupportDnd00","250","87","293","23",null,null,null,null,null,null,this);
            obj.set_taborder("17");
            ...
            obj = new Static("staSupportDnd00_00","250","105","293","23",null,null,null,null,null,null,this);
            obj.set_taborder("18");
            ...
            obj = new CheckBox("chk_postData","159","181","150","20",null,null,null,null,null,null,this);
            obj.set_taborder("19");
            obj.set_text("postData 포함 여부@");
            obj.set_value("true");
            this.addChild(obj.name, obj);

            obj = new Radio("rdo_postType","320","175","200","30",null,null,null,null,null,null,this);
            obj.set_taborder("20");
        ...
        // User Script
        this.registerScript("pattern03-FileUpDownloadTrans.xfdl", function() {
        /**
        *  nexacro 17 demo
        *  @MenuPath    대메뉴 > 소메뉴
        ...
        */
        this.fnDownloadFile = function(i)
        {
        	...
        	this.fileDownTrans.setPostData( "filename", this.dsDownload.getColumn(i, "FILE_NAME") );
        ...
        */
        ...
        this.loadIncludeScript("pattern03-FileUpDownloadTrans.xfdl");
