(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"80\"/><Column size=\"250\"/><Column size=\"570\"/><Column size=\"80\"/><Column size=\"48\"/></Columns><Rows><Row size=\"25\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"글 ID\"/><Cell col=\"1\" text=\"제목\"/><Cell col=\"2\" text=\"내용\"/><Cell col=\"3\" text=\"등록일자\"/><Cell col=\"4\" text=\"조회수\"/></Band><Band id=\"body\"><Cell text=\"bind:POST_ID\"/><Cell col=\"1\" text=\"bind:TITLE\" edittype=\"normal\"/><Cell col=\"2\" text=\"bind:CONTENTS\" edittype=\"normal\"/><Cell col=\"3\" text=\"bind:REG_DATE\"/><Cell col=\"4\" text=\"bind:HIT_COUNT\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
