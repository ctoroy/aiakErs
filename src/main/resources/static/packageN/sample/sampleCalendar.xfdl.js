(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"dtFrom\" type=\"STRING\" size=\"256\"/><Column id=\"dtTo\" type=\"STRING\" size=\"256\"/><Column id=\"dtMonth\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"dtFrom\">20240131</Col><Col id=\"dtTo\">20241231</Col><Col id=\"dtMonth\">202412</Col></Row></Rows>");
            ...
            obj = new Div("divCalFromTo01","786","16","220","26",null,null,null,null,null,null,this);
            obj.set_taborder("33");
            obj.set_text("Div00");
            obj.set_url("cmm::cmmCalFromTo.xfdl");
            this.addChild(obj.name, obj);

            obj = new Div("divCalMM00","910","44","98","26",null,null,null,null,null,null,this);
            obj.set_taborder("34");
            obj.set_text("Div00");
            obj.set_url("cmm::cmmCalMM.xfdl");
            this.addChild(obj.name, obj);
        ...
        *******************************************************************************
        */
        this.sample015_calendar_onload = function(obj,e)
        {
        	this.dsList.setColumn(0,dtFrom, this.yyyymmdd());
        	this.dsList.setColumn(0,dtTo, this.yyyyLastday()());
        	this.dsList.setColumn(0,dtMonth, this.yyyymm());

        	this.divCalFromTo.fnSetFromDate(this.dsList.getColumn(0,dtFrom));
        	this.divCalFromTo.fnSetToDate(this.dsList.getColumn(0,dtTo));
        };
        ...
        */
        ...
        this.btnTest_onclick = function(obj,e)
        {
        	...
        	trace("gfnGetLastDate : " + this.gfnGetLastDate(this.yyyymmdd()));

        	trace("gfnGetLastDate : " + this.gfnGetLastDate(this.yyyymm()));

        	trace("gfnGetFirstDate : " + this.gfnGetFirstDate(this.yyyymmdd()));

        	trace("gfnGetDay : " + this.gfnGetDay(this.yyyymmdd()));

        	trace("gfnGetDiffDate : " + this.gfnGetDiffDate(this.yyyymmdd(), this.yyyyLastday()));

        	trace("gfnGetDiffMonth : " + this.gfnGetDiffMonth(this.yyyymmdd(), this.yyyyLastday()));

        	trace("gfnAddDate : " + this.gfnAddDate(this.yyyymmdd(), 3));

        	trace("gfnAddMonth : " + this.gfnAddMonth(this.yyyymmdd(), 1));

        	trace("gfnAddMonth : " + this.gfnAddMonth(this.yyyymmdd(), -1));

        	trace("gfnGetWeek : " + this.gfnGetWeek(this.yyyymmdd()));

        	var sDate = this.gfnSolarToLunar(this.yyyymmdd());
        	trace("gfnSolarToLunar : " + sDate);

        	trace("gfnLunarToSolar : " + this.gfnLunarToSolar(sDate.substring(1,9), sDate.substring(0,1)));
        };

        this.yyyymmdd = function(delim = "") {
        	var today = new Date();
        ...
        this.yyyyLastday = function(delim = "") {
        	var today = new Date();

        	var year = today.getFullYear();

        	return year + delim + "12"  + delim + "31";
        }
        ...
        {
            this.addEventHandler("onload",this.sample015_calendar_onload,this);
