...
import aia.ers.application.pojo.Dept;
import aia.ers.application.service.DeptService;
...
public class DeptController {
     ...
     * @return
     */
    @RequestMapping(value = "/save_deptlist.do")
	public NexacroResult save_datalist(@ParamDataSet(name = "input1") List<Dept> dataList) throws NexacroException{
    	
    	DeptService.save_datalist(dataList);
     ...
     * @return
     */
    @RequestMapping(value = "/save_deptlist_map.do")
	public NexacroResult save_datalist_map(@ParamDataSet(name = "input1") List<Map<String,Object>> dataList) throws NexacroException{
    	
    	DeptService.save_datalist_map(dataList);
