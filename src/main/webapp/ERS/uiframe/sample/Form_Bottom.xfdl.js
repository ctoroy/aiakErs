(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static00","30","0","680","23",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("조회가 완료되었습니다.");
            obj.set_cssclass("sta_BF_Info");
            this.addChild(obj.name, obj);

            obj = new Static("Static00_00",null,"0","250","23","109",null,null,null,null,null,this);
            obj.set_taborder("1");
            ...
            obj = new Static("Static00_00_00","Static00_00:0","0","80","23",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            ...
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","Desktop_screen",1080,23,this,function(p){});
