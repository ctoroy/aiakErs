    ...
    return function()
    {
        ...
        */
        ...
        this.fnCreatePage = function(objGrid, sFnCallback, nPage, nRecords, nTotalRecords)
        {
        	...
        	// 페이지 당 건수 설정
        	this.cboCnt.set_value(nRecords);
           ...
           // 다음페이지
            ...
            if(sPageView == "all" || sPageView == "number")
            {
        		...
        		objBtnFirst.set_cssclass("btn_WF_PageF");
        		objBtnFirst.page = 1;
        		...
        		objBtnBefore.set_cssclass("btn_WF_PageP");
        		...
        		objBtnNext.set_cssclass("btn_WF_PageN");
        		...
        		objBtnEnd.set_cssclass("btn_WF_PageE");
