(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            {
                this._setFormPosition(1270,3700);
            }
            
            // Object(Dataset, ExcelExportObject) Initialize
            obj = new Dataset("dc_grd", this);
            obj._setContents("<ColumnInfo><Column id=\"체크박스\" type=\"STRING\" size=\"256\"/><Column id=\"NO\" type=\"STRING\" size=\"256\"/><Column id=\"Edit\" type=\"STRING\" size=\"256\"/><Column id=\"MaskEdit\" type=\"STRING\" size=\"256\"/><Column id=\"Combo\" type=\"STRING\" size=\"256\"/><Column id=\"Calendar\" type=\"STRING\" size=\"256\"/><Column id=\"Expand\" type=\"STRING\" size=\"256\"/><Column id=\"Text\" type=\"STRING\" size=\"256\"/><Column id=\"Number\" type=\"STRING\" size=\"256\"/><Column id=\"Button\" type=\"STRING\" size=\"256\"/><Column id=\"ProgressBar\" type=\"STRING\" size=\"256\"/><Column id=\"code\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"Edit\">AIA생명</Col><Col id=\"MaskEdit\">12345</Col><Col id=\"Calendar\">20201225</Col><Col id=\"Expand\"/><Col id=\"Combo\">가나다라</Col><Col id=\"Number\">1500000</Col><Col id=\"Text\">가나다라마</Col><Col id=\"체크박스\">1</Col><Col id=\"Button\">버튼</Col><Col id=\"NO\">01</Col><Col id=\"ProgressBar\">50%</Col><Col id=\"code\">0</Col></Row><Row><Col id=\"Edit\">AIA생명</Col><Col id=\"MaskEdit\">12345</Col><Col id=\"Calendar\">20201225</Col><Col id=\"Expand\"/><Col id=\"Combo\">가나다라</Col><Col id=\"Text\">가나다라마</Col><Col id=\"Number\">1500000</Col><Col id=\"체크박스\"/><Col id=\"Button\">버튼</Col><Col id=\"NO\">02</Col><Col id=\"ProgressBar\">50%</Col><Col id=\"code\">1</Col></Row><Row><Col id=\"Edit\">AIA생명</Col><Col id=\"MaskEdit\">12345</Col><Col id=\"Calendar\">20201225</Col><Col id=\"Expand\"/><Col id=\"Combo\">가나다라</Col><Col id=\"Text\">가나다라마</Col><Col id=\"Number\">1500000</Col><Col id=\"체크박스\"/><Col id=\"Button\">버튼</Col><Col id=\"NO\">03</Col><Col id=\"ProgressBar\">50%</Col><Col id=\"code\">2</Col></Row><Row><Col id=\"Edit\">AIA생명</Col><Col id=\"체크박스\"/><Col id=\"MaskEdit\">12345</Col><Col id=\"Calendar\">20201225</Col><Col id=\"Expand\"/><Col id=\"Combo\">가나다라</Col><Col id=\"Text\">가나다라마</Col><Col id=\"Number\">1500000</Col><Col id=\"Button\">버튼</Col><Col id=\"NO\">04</Col><Col id=\"ProgressBar\">50%</Col><Col id=\"code\">3</Col></Row><Row><Col id=\"Edit\">AIA생명</Col><Col id=\"MaskEdit\">12345</Col><Col id=\"Calendar\">20201225</Col><Col id=\"Expand\"/><Col id=\"Combo\">가나다라</Col><Col id=\"Text\">가나다라마</Col><Col id=\"Number\">1500000</Col><Col id=\"체크박스\"/><Col id=\"Button\">버튼</Col><Col id=\"NO\">05</Col><Col id=\"ProgressBar\">50%</Col><Col id=\"code\">4</Col></Row><Row><Col id=\"Edit\">AIA생명</Col><Col id=\"MaskEdit\">12345</Col><Col id=\"Calendar\">20201225</Col><Col id=\"Expand\"/><Col id=\"Combo\">가나다라</Col><Col id=\"Text\">가나다라마</Col><Col id=\"Number\">1500000</Col><Col id=\"체크박스\"/><Col id=\"Button\">버튼</Col><Col id=\"NO\">06</Col><Col id=\"ProgressBar\">50%</Col><Col id=\"code\">5</Col></Row></Rows>");
            ...
            obj = new Static("sta109_00","48","1474",null,"1784","52",null,null,null,null,null,this);
            obj.set_taborder("40");
            obj.set_cssclass("sta_WF_Box");
            obj.set_text("");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"48\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"134\"/><Column size=\"157\"/><Column size=\"48\"/><Column size=\"100\"/><Column size=\"90\"/><Column size=\"80\"/><Column size=\"70\"/><Column size=\"80\"/></Columns><Rows><Row size=\"32\" band=\"head\"/><Row size=\"28\"/><Row size=\"28\" band=\"summ\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkboxcontrol\"/><Cell col=\"1\" text=\"NO\"/><Cell col=\"2\" text=\"Edit\"/><Cell col=\"3\" text=\"MaskEdit\"/><Cell col=\"4\" text=\"Combo\"/><Cell col=\"5\" text=\"Calendar\"/><Cell col=\"6\"/><Cell col=\"7\" text=\"Expand\"/><Cell col=\"8\" text=\"Text\"/><Cell col=\"9\" text=\"Number\"/><Cell col=\"10\" text=\"Button\"/><Cell col=\"11\" text=\"ProgressBar\"/></Band><Band id=\"body\"><Cell text=\"bind:체크박스\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"bind:NO\" displaytype=\"text\" edittype=\"none\"/><Cell col=\"2\" displaytype=\"editcontrol\" edittype=\"text\" text=\"bind:Edit\"/><Cell col=\"3\" displaytype=\"maskeditcontrol\" edittype=\"mask\" text=\"bind:MaskEdit\"/><Cell col=\"4\" displaytype=\"combocontrol\" edittype=\"combo\" text=\"bind:Combo\" combodataset=\"ds00\" combodatacol=\"text\" combocodecol=\"code\"/><Cell col=\"5\" displaytype=\"calendarcontrol\" edittype=\"date\" text=\"bind:Calendar\" calendardateformat=\"yyyy-MM-dd \"/><Cell col=\"6\" expandshow=\"show\" expandsize=\"30\" cssclass=\"cell_WF_Cal\"/><Cell col=\"7\" text=\"bind:Expand\" edittype=\"text\" expandshow=\"show\" expandsize=\"30\" cssclass=\"cell_WF_Edit\" displaytype=\"editcontrol\"/><Cell col=\"8\" displaytype=\"normal\" text=\"bind:Text\"/><Cell col=\"9\" text=\"bind:Number\" displaytype=\"number\" edittype=\"none\"/><Cell col=\"10\" text=\"bind:Button\" displaytype=\"buttoncontrol\" edittype=\"button\"/><Cell col=\"11\" text=\"bind:ProgressBar\" displaytype=\"progressbarcontrol\" progressbarsmooth=\"true\"/></Band><Band id=\"summary\"><Cell colspan=\"9\" text=\"총계\" displaytype=\"text\"/><Cell col=\"9\" colspan=\"3\" text=\"1,500,000,000\" displaytype=\"number\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj.set_binddataset("dc_grd01");
            obj.set_autofittype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"55\"/><Column size=\"180\"/><Column size=\"60\"/><Column size=\"80\"/><Column size=\"100\"/><Column size=\"70\"/><Column size=\"70\"/><Column size=\"100\"/><Column size=\"70\"/><Column size=\"70\"/><Column size=\"60\"/></Columns><Rows><Row size=\"32\" band=\"head\"/><Row size=\"32\" band=\"head\"/><Row size=\"28\"/><Row size=\"28\"/></Rows><Band id=\"head\"><Cell rowspan=\"2\" text=\"NO\"/><Cell col=\"1\" rowspan=\"2\" text=\"라벨\"/><Cell col=\"2\" rowspan=\"2\" text=\"체크\"/><Cell col=\"3\" rowspan=\"2\" text=\"라벨\"/><Cell col=\"4\" rowspan=\"2\" text=\"라벨\"/><Cell col=\"5\" rowspan=\"2\" text=\"라벨\"/><Cell col=\"6\" rowspan=\"2\" text=\"라벨\"/><Cell col=\"7\" rowspan=\"2\" text=\"라벨\"/><Cell col=\"8\" colspan=\"2\" text=\"라벨\"/><Cell col=\"10\" rowspan=\"2\" text=\"라벨\"/><Cell row=\"1\" col=\"8\" text=\"라벨\"/><Cell row=\"1\" col=\"9\" text=\"라벨\"/></Band><Band id=\"body\"><Cell text=\"bind:NO\" displaytype=\"text\"/><Cell col=\"1\" text=\"bind:매입계산서번호\" displaytype=\"text\"/><Cell col=\"2\" text=\"bind:전표발행\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"3\" text=\"bind:정산일\" displaytype=\"text\"/><Cell col=\"4\" text=\"bind:발생일자\" displaytype=\"text\"/><Cell col=\"5\" text=\"bind:시간구분\" displaytype=\"text\"/><Cell col=\"6\" text=\"bind:과세구분\" displaytype=\"text\"/><Cell col=\"7\" text=\"bind:대금지불유형\" displaytype=\"text\"/><Cell col=\"8\" colspan=\"2\" text=\"가나다\"/><Cell col=\"10\" text=\"bind:단위\" displaytype=\"text\"/><Cell row=\"1\" text=\"bind:NO\" displaytype=\"text\"/><Cell row=\"1\" col=\"1\" text=\"bind:매입계산서번호\" displaytype=\"text\"/><Cell row=\"1\" col=\"2\" text=\"bind:전표발행\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell row=\"1\" col=\"3\" text=\"bind:정산일\" displaytype=\"text\"/><Cell row=\"1\" col=\"4\" text=\"bind:발생일자\" displaytype=\"text\"/><Cell row=\"1\" col=\"5\" text=\"bind:시간구분\" displaytype=\"text\"/><Cell row=\"1\" col=\"6\" text=\"bind:과세구분\" displaytype=\"text\"/><Cell row=\"1\" col=\"7\" text=\"bind:대금지불유형\" displaytype=\"text\"/><Cell row=\"1\" col=\"8\" text=\"가나다\"/><Cell row=\"1\" col=\"9\" text=\"가나다\"/><Cell row=\"1\" col=\"10\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj.set_binddataset("dc_grd");
            obj.set_autofittype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/></Columns><Rows><Row size=\"32\" band=\"head\"/><Row size=\"28\"/><Row size=\"28\"/><Row size=\"28\"/><Row size=\"28\"/><Row size=\"28\" band=\"summ\"/><Row size=\"28\" band=\"summ\"/><Row size=\"28\" band=\"summ\"/></Rows><Band id=\"head\"><Cell text=\"셀고정\" cssclass=\"cell_WF_fixing\"/><Cell col=\"1\" text=\"필수\" cssclass=\"essential\"/><Cell col=\"2\" text=\"텍스트정렬\"/><Cell col=\"3\" text=\"강조 텍스트컬러\"/><Cell col=\"4\" text=\"강조 바탕컬러\"/></Band><Band id=\"body\"><Cell/><Cell col=\"1\"/><Cell col=\"2\" cssclass=\"cell_WF_Left\" text=\"왼쪽정렬\"/><Cell col=\"3\" text=\"주의\" cssclass=\"cell_WF_Point01\"/><Cell col=\"4\" text=\"주의\" cssclass=\"cell_WF_PointTxt01\"/><Cell row=\"1\"/><Cell row=\"1\" col=\"1\"/><Cell row=\"1\" col=\"2\" text=\"오른쪽정렬\" cssclass=\"cell_WF_Right\"/><Cell row=\"1\" col=\"3\" text=\"주의\" cssclass=\"cell_WF_Point02\"/><Cell row=\"1\" col=\"4\" text=\"주의\" cssclass=\"cell_WF_PointTxt02\"/><Cell row=\"2\"/><Cell row=\"2\" col=\"1\"/><Cell row=\"2\" col=\"2\" cssclass=\"cell_WF_Link\" text=\"링크텍스트\"/><Cell row=\"2\" col=\"3\" text=\"긍정\" cssclass=\"cell_WF_Point03\"/><Cell row=\"2\" col=\"4\" text=\"긍정\" cssclass=\"cell_WF_PointTxt03\"/><Cell row=\"3\"/><Cell row=\"3\" col=\"1\"/><Cell row=\"3\" col=\"2\"/><Cell row=\"3\" col=\"3\" text=\"긍정\" cssclass=\"cell_WF_Point04\"/><Cell row=\"3\" col=\"4\" text=\"긍정\" cssclass=\"cell_WF_PointTxt04\"/></Band><Band id=\"summary\"><Cell colspan=\"4\" text=\"소계01\" displaytype=\"text\" cssclass=\"cell_WF_Sum01\"/><Cell col=\"4\" text=\"235,000\" cssclass=\"cell_WF_Sum01\"/><Cell row=\"1\" colspan=\"4\" text=\"소계02\" displaytype=\"text\" cssclass=\"cell_WF_Sum01\"/><Cell row=\"1\" col=\"4\" text=\"235,000\" cssclass=\"cell_WF_Sum01\"/><Cell row=\"2\" colspan=\"4\" text=\"총계\" displaytype=\"text\"/><Cell row=\"2\" col=\"4\" text=\"235,000\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"48\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"110\"/><Column size=\"157\"/><Column size=\"100\"/><Column size=\"90\"/><Column size=\"80\"/><Column size=\"70\"/><Column size=\"80\"/></Columns><Rows><Row size=\"32\" band=\"head\"/><Row size=\"28\"/><Row size=\"28\" band=\"summ\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkboxcontrol\"/><Cell col=\"1\" text=\"NO\"/><Cell col=\"2\" text=\"Edit\"/><Cell col=\"3\" text=\"MaskEdit\"/><Cell col=\"4\" text=\"Combo\"/><Cell col=\"5\" text=\"Calendar\"/><Cell col=\"6\" text=\"Expand\"/><Cell col=\"7\" text=\"Text\"/><Cell col=\"8\" text=\"Number\"/><Cell col=\"9\" text=\"Button\"/><Cell col=\"10\" text=\"ProgressBar\"/></Band><Band id=\"body\"><Cell text=\"bind:체크박스\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"bind:NO\" displaytype=\"text\" edittype=\"none\"/><Cell col=\"2\" displaytype=\"editcontrol\" edittype=\"text\" text=\"bind:Edit\"/><Cell col=\"3\" displaytype=\"maskeditcontrol\" edittype=\"mask\" text=\"bind:MaskEdit\"/><Cell col=\"4\" displaytype=\"combocontrol\" edittype=\"combo\" text=\"bind:Combo\" combodataset=\"ds00\" combodatacol=\"text\" combocodecol=\"code\"/><Cell col=\"5\" displaytype=\"calendarcontrol\" edittype=\"date\" text=\"bind:Calendar\" calendardateformat=\"yyyy-MM-dd \"/><Cell col=\"6\" text=\"bind:Expand\" edittype=\"text\" expandshow=\"show\" expandsize=\"30\" cssclass=\"cell_WF_Edit\" displaytype=\"editcontrol\"/><Cell col=\"7\" displaytype=\"normal\" text=\"bind:Text\"/><Cell col=\"8\" text=\"bind:Number\" displaytype=\"number\" edittype=\"none\"/><Cell col=\"9\" text=\"bind:Button\" displaytype=\"buttoncontrol\" edittype=\"button\"/><Cell col=\"10\" text=\"bind:ProgressBar\" displaytype=\"progressbarcontrol\" progressbarsmooth=\"true\"/></Band><Band id=\"summary\"><Cell colspan=\"8\" text=\"총계\" displaytype=\"text\"/><Cell col=\"8\" colspan=\"3\" text=\"1,500,000,000\" displaytype=\"number\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static07",null,"303","9","7","243",null,null,null,null,null,this);
            obj.set_taborder("23");
            obj.set_cssclass("sta_WF_GLineV");
            obj.set_visible("false");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static11",null,"284","22","13","1092",null,null,null,null,null,this);
            obj.set_taborder("25");
            obj.set_text("24");
            obj.set_cssclass("sta_WF_GTxt04");
            obj.set_visible("false");
            ...
            obj = new Static("Static12",null,"277","9","28","1093",null,null,null,null,null,this);
            obj.set_taborder("26");
            obj.set_cssclass("sta_WF_GLineV");
            obj.set_visible("false");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static18","729","1087","9","32",null,null,null,null,null,null,this);
            obj.set_taborder("29");
            obj.set_cssclass("sta_WF_GLineV");
            obj.set_visible("false");
            this.addChild(obj.name, obj);

            obj = new Static("Static17","729","1119","9","32",null,null,null,null,null,null,this);
            obj.set_taborder("30");
            obj.set_cssclass("sta_WF_GLineV");
            obj.set_visible("false");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"48\"/><Column size=\"100\"/><Column size=\"100\"/></Columns><Rows><Row size=\"32\" band=\"head\"/><Row size=\"28\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkboxcontrol\"/><Cell col=\"1\" text=\"NO\"/><Cell col=\"2\" text=\"Edit\"/><Cell col=\"3\" text=\"MaskEdit\"/></Band><Band id=\"body\"><Cell/><Cell col=\"1\"/><Cell col=\"2\"/><Cell col=\"3\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new Grid("Grid04_00","100","2900","326","86",null,null,null,null,null,null,this);
            obj.set_taborder("41");
            obj.set_autofittype("col");
            obj.set_cssclass("grd_WF_NoneS");
            obj.set_binddataset("ds_dash");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"100\"/><Column size=\"100\"/></Columns><Rows><Row size=\"28\"/><Row size=\"28\"/><Row size=\"28\" band=\"summ\"/></Rows><Band id=\"body\"><Cell text=\"BUDGET\" cssclass=\"cell_WF_Point01\" font=\"normal 13px/normal &quot;SpoqaHanSansNeo-Medium&quot;\"/><Cell col=\"1\" text=\"KRW (%)\" cssclass=\"cell_WF_Point01\" textAlign=\"right\"/><Cell row=\"1\" text=\"ACTUAL\" cssclass=\"cell_WF_Point01\" font=\"normal 13px/normal &quot;SpoqaHanSansNeo-Medium&quot;\"/><Cell row=\"1\" col=\"1\" text=\"KRW (%)\" cssclass=\"cell_WF_Point01\" textAlign=\"right\"/></Band><Band id=\"summary\"><Cell text=\"REMAIN\" color=\"#d31145\"/><Cell col=\"1\" text=\"KRW (%)\" textAlign=\"right\" color=\"#d31145\" font=\"normal 13px/normal &quot;SpoqaHanSansNeo-Regular&quot;\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Grid("Grid04_00_00","480","2900","326","142",null,null,null,null,null,null,this);
            obj.set_taborder("42");
            obj.set_autofittype("col");
            obj.set_cssclass("grd_WF_NoneS");
            obj.set_binddataset("ds_dash");
            obj.set_summarytype("top");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/></Columns><Rows><Row size=\"28\"/><Row size=\"28\"/><Row size=\"28\"/><Row size=\"28\"/><Row size=\"28\" band=\"summ\"/></Rows><Band id=\"body\"><Cell/><Cell col=\"1\" text=\"BUDGET\" cssclass=\"cell_WF_Point01\" textAlign=\"right\" font=\"normal 13px/normal &quot;SpoqaHanSansNeo-Medium&quot;\"/><Cell col=\"2\" text=\"ACTUAL\" cssclass=\"cell_WF_Point01\" textAlign=\"right\" font=\"normal 13px/normal &quot;SpoqaHanSansNeo-Medium&quot;\"/><Cell col=\"3\" background=\"#edf0f5\"/><Cell row=\"1\" text=\"TRIP\" cssclass=\"cell_WF_Point01\" font=\"normal 13px/normal &quot;SpoqaHanSansNeo-Medium&quot;\"/><Cell row=\"1\" col=\"1\" text=\"KRW\" cssclass=\"cell_WF_Point01\" textAlign=\"right\"/><Cell row=\"1\" col=\"2\" cssclass=\"cell_WF_Point01\" text=\"KRW\" textAlign=\"right\"/><Cell row=\"1\" col=\"3\" cssclass=\"cell_WF_Point01\" background=\"#edf0f5\" text=\"KRW\" textAlign=\"right\"/><Cell row=\"2\" text=\"ENT\" cssclass=\"cell_WF_Point01\" font=\"normal 13px/normal &quot;SpoqaHanSansNeo-Medium&quot;\"/><Cell row=\"2\" col=\"1\" text=\"KRW\" cssclass=\"cell_WF_Point01\" textAlign=\"right\"/><Cell row=\"2\" col=\"2\" cssclass=\"cell_WF_Point01\" text=\"KRW\" textAlign=\"right\"/><Cell row=\"2\" col=\"3\" cssclass=\"cell_WF_Point01\" background=\"#edf0f5\" text=\"KRW\" textAlign=\"right\"/><Cell row=\"3\" text=\"OTHERS\" cssclass=\"cell_WF_Point01\" font=\"normal 13px/normal &quot;SpoqaHanSansNeo-Medium&quot;\"/><Cell row=\"3\" col=\"1\" cssclass=\"cell_WF_Point01\" text=\"KRW\" textAlign=\"right\"/><Cell row=\"3\" col=\"2\" cssclass=\"cell_WF_Point01\" text=\"KRW\" textAlign=\"right\"/><Cell row=\"3\" col=\"3\" cssclass=\"cell_WF_Point01\" background=\"#edf0f5\" text=\"KRW\" textAlign=\"right\"/></Band><Band id=\"summary\"><Cell color=\"#d31145\"/><Cell col=\"1\" textAlign=\"right\"/><Cell col=\"2\" color=\"#d31145\"/><Cell col=\"3\" color=\"#d31145\" text=\"REMAIN\" textAlign=\"right\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Div("divCmmnBtn00",null,"279","340","24","133",null,null,null,null,null,this);
            obj.set_taborder("43");
            obj.set_text("Div01");
            this.addChild(obj.name, obj);

            obj = new Button("Button35","183","0","77","24",null,null,null,null,null,null,this.divCmmnBtn00.form);
            obj.set_taborder("1");
            obj.set_text("행추가");
            obj.set_cssclass("btn_WF_Add");
            this.divCmmnBtn00.addChild(obj.name, obj);

            obj = new Button("Button36","263","0","77","24",null,null,null,null,null,null,this.divCmmnBtn00.form);
            obj.set_taborder("0");
            obj.set_text("행삭제");
            obj.set_cssclass("btn_WF_Delete");
            this.divCmmnBtn00.addChild(obj.name, obj);

            obj = new Button("btnCust01_00","136","0","44","24",null,null,null,null,null,null,this.divCmmnBtn00.form);
            obj.set_taborder("2");
            obj.set_cssclass("btn_WF_ExcelUp");
            this.divCmmnBtn00.addChild(obj.name, obj);

            obj = new Button("btnCust00_00","89","0","44","24",null,null,null,null,null,null,this.divCmmnBtn00.form);
            obj.set_taborder("3");
            obj.set_cssclass("btn_WF_ExcelDown");
            this.divCmmnBtn00.addChild(obj.name, obj);

            obj = new Button("Button48","0","0","86","24",null,null,null,null,null,null,this.divCmmnBtn00.form);
            obj.set_taborder("4");
            obj.set_text("커스텀버튼");
            this.divCmmnBtn00.addChild(obj.name, obj);
            // Layout Functions
            ...
            //-- Default Layout : this
            obj = new Layout("default","",1270,3700,this,function(p){});
