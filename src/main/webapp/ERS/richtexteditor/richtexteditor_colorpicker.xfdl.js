(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("richtexteditor_colorpicker.xfdl","richtexteditor::lib_color.xjs");
        ...
        this.allowSliderMaxTop = ((this.lightBarTop + parseInt(this.lightnessBar.height)) - this.sliderHalfHeight);
